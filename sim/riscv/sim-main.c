...
execute_i (SIM_CPU *cpu, unsigned_word iw, const struct riscv_opcode *op, int ex9)
{
  ...
  switch (op->match)
    ...
    case MATCH_ADDIGP: {
      ...
      store_rd (cpu, rd, cpu->regs[X_GP] + gp_imm);
      break;
    }
    case MATCH_ADDI:
    ...
    case MATCH_LDGP: {
      unsigned_word gp_imm = EXTRACT_GPTYPE_LD_IMM(iw);
      TRACE_INSN (cpu, "ldgp %s, %"PRIiTW"; // ",
		  rd_name, gp_imm, rs1_name);
      RISCV_ASSERT_RV64 (cpu, "insn: %s", op->name);
      store_rd (cpu, rd, 
	sim_core_read_unaligned_8 (cpu, cpu->pc, read_map,
				   cpu->regs[X_GP] + gp_imm));
      break;
    }
    case MATCH_LD:
	...
	sim_core_read_unaligned_8 (cpu, cpu->pc, read_map,
      ...
      break;
    case MATCH_LWGP: {
      unsigned_word gp_imm = EXTRACT_GPTYPE_LW_IMM(iw);
	...
	sim_core_read_unaligned_4 (cpu, cpu->pc, read_map,
      ...
      break;
    case MATCH_LHGP: {
      unsigned_word gp_imm = EXTRACT_GPTYPE_LH_IMM(iw);
	...
	sim_core_read_unaligned_1 (cpu, cpu->pc, read_map,
      ...
      break;
    case MATCH_SDGP: {
      unsigned_word gp_imm = EXTRACT_GPTYPE_SD_IMM(iw);
      TRACE_INSN (cpu, "sdgp %s, %"PRIiTW"; // ",
		  rs2_name, gp_imm);
      RISCV_ASSERT_RV64 (cpu, "insn: %s", op->name);
      sim_core_write_unaligned_8 (cpu, cpu->pc, write_map,
				  cpu->regs[X_GP] + gp_imm, cpu->regs[rs2]);
      break;
    }
    case MATCH_SD:
      ...
      break;
    case MATCH_SWGP: {
      unsigned_word gp_imm = EXTRACT_GPTYPE_SW_IMM(iw);
    ...
    case MATCH_SW:
      ...
      break;
    case MATCH_SHGP: {
      unsigned_word gp_imm = EXTRACT_GPTYPE_SH_IMM(iw);
    ...
    case MATCH_SH:
      ...
      break;
    case MATCH_SBGP: {
      unsigned_word gp_imm = EXTRACT_GPTYPE_SB_IMM(iw);
    ...
    case MATCH_SBR:
      ...
      break;
    case MATCH_LDR_ZE:
      TRACE_INSN (cpu, "ldr.ze %s, [%s + (%s << %d)]; // ", rd_name, rs1_name,
		  rs2_name, sv);
      RISCV_ASSERT_RV64 (cpu, "insn: %s", op->name);
      store_rd (cpu, rd,
		sim_core_read_unaligned_8 (cpu, cpu->pc, read_map,
					   cpu->regs[rs1] +
					   (SIM_RV_X (cpu->regs[rs2], 0, 32) << sv)));
      break;
    case MATCH_LWR_ZE:
      TRACE_INSN (cpu, "lwr.ze %s, [%s + (%s << %d)]; // ", rd_name, rs1_name,
		  rs2_name, sv);
      store_rd (cpu, rd,
		EXTEND32 (sim_core_read_unaligned_4
			  (cpu, cpu->pc, read_map,
			   cpu->regs[rs1] + (SIM_RV_X (cpu->regs[rs2], 0, 32) << sv))));
      break;
    case MATCH_LWUR_ZE:
      TRACE_INSN (cpu, "lwur.ze %s, [%s + (%s << %d)]; // ", rd_name, rs1_name,
		  rs2_name, sv);
      store_rd (cpu, rd,
		sim_core_read_unaligned_4 (cpu, cpu->pc, read_map,
					   cpu->regs[rs1] +
      ...
      break;
    case MATCH_LHR_ZE:
      TRACE_INSN (cpu, "lhr.ze %s, [%s + (%s << %d)]; // ", rd_name, rs1_name,
		  rs2_name, sv);
      store_rd (cpu, rd,
		EXTEND16 (sim_core_read_unaligned_2
			  (cpu, cpu->pc, read_map,
      ...
      break;
    case MATCH_LHUR_ZE:
      TRACE_INSN (cpu, "lhur.ze %s, [%s + (%s << %d)]; // ", rd_name, rs1_name,
		  rs2_name, sv);
      store_rd (cpu, rd,
		sim_core_read_unaligned_2 (cpu, cpu->pc, read_map,
					   cpu->regs[rs1] +
      ...
      break;
    case MATCH_LBR_ZE:
      TRACE_INSN (cpu, "lbr.ze %s, [%s + (%s << %d)]; // ", rd_name, rs1_name,
		  rs2_name, sv);
      store_rd (cpu, rd,
		EXTEND8 (sim_core_read_unaligned_1
			 (cpu, cpu->pc, read_map,
      ...
      break;
    case MATCH_LBUR_ZE:
      TRACE_INSN (cpu, "lbur.ze %s, [%s + (%s << %d)]; // ", rd_name, rs1_name,
		  rs2_name, sv);
      store_rd (cpu, rd,
		sim_core_read_unaligned_1 (cpu, cpu->pc, read_map,
					   cpu->regs[rs1] +
      ...
      break;
    case MATCH_SDR_ZE:
      TRACE_INSN (cpu, "sdr.ze %s, [%s + (%s << %d)]; // ", rd_name, rs1_name,
		  rs2_name, sv);
      RISCV_ASSERT_RV64 (cpu, "insn: %s", op->name);
      sim_core_write_unaligned_8 (cpu, cpu->pc, write_map,
				  cpu->regs[rs1] + (SIM_RV_X (cpu->regs[rs2], 0, 32) << sv),
      ...
      break;
    case MATCH_SWR_ZE:
      TRACE_INSN (cpu, "swr.ze %s, [%s + (%s << %d)]; // ", rd_name, rs1_name,
		  rs2_name, sv);
      sim_core_write_unaligned_4 (cpu, cpu->pc, write_map,
				  cpu->regs[rs1] + (SIM_RV_X (cpu->regs[rs2], 0, 32) << sv),
				  cpu->regs[rd]);
      break;
    case MATCH_SHR_ZE:
      TRACE_INSN (cpu, "shr.ze %s, [%s + (%s << %d)]; // ", rd_name, rs1_name,
		  rs2_name, sv);
      sim_core_write_unaligned_2 (cpu, cpu->pc, write_map,
				  cpu->regs[rs1] + (SIM_RV_X (cpu->regs[rs2], 0, 32) << sv),
				  cpu->regs[rd]);
      break;
    case MATCH_SBR_ZE:
      TRACE_INSN (cpu, "sbr.ze %s, [%s + (%s << %d)]; // ", rd_name, rs1_name,
		  rs2_name, sv);
      sim_core_write_unaligned_1 (cpu, cpu->pc, write_map,
				  cpu->regs[rs1] + (SIM_RV_X (cpu->regs[rs2], 0, 32) << sv),
				  cpu->regs[rd]);
    ...
    case MATCH_LEA_B_ZE:
      TRACE_INSN (cpu, "lea.b.ze %s, %s, %s;  // %s = %s + (ZE(%s) << 0)",
		  rd_name, rs1_name, rs2_name, rd_name, rs1_name, rs2_name);
      store_rd (cpu, rd, cpu->regs[rs1] + (SIM_RV_X (cpu->regs[rs2], 0, 32) << 0));
      break;
    case MATCH_LEA_H_ZE:
      TRACE_INSN (cpu, "lea.h.ze %s, %s, %s;  // %s = %s + (ZE(%s) << 1)",
		  rd_name, rs1_name, rs2_name, rd_name, rs1_name, rs2_name);
      store_rd (cpu, rd, cpu->regs[rs1] + (SIM_RV_X (cpu->regs[rs2], 0, 32) << 1));
      break;
    case MATCH_LEA_W_ZE:
      TRACE_INSN (cpu, "lea.h.ze %s, %s, %s;  // %s = %s + (ZE(%s) << 2)",
		  rd_name, rs1_name, rs2_name, rd_name, rs1_name, rs2_name);
      store_rd (cpu, rd, cpu->regs[rs1] + (SIM_RV_X (cpu->regs[rs2], 0, 32) << 2));
      break;
    case MATCH_LEA_D_ZE:
      TRACE_INSN (cpu, "lea.d.ze %s, %s, %s;  // %s = %s + (ZE(%s) << 3)",
		  rd_name, rs1_name, rs2_name, rd_name, rs1_name, rs2_name);
      store_rd (cpu, rd, cpu->regs[rs1] + (SIM_RV_X (cpu->regs[rs2], 0, 32) << 3));
      break;
    case MATCH_BEQC:
