...
// DECLARE_CSR(ucode, CSR_UCODE, CSR_CLASS_P, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
...
DECLARE_CSR(mccache_ctl_base, CSR_MCCACHE_CTL_BASE, CSR_CLASS_XANDES, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
