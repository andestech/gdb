...
{"add8",      "P",   "d,s,t",     MATCH_ADD8, MASK_ADD8, match_opcode, 0 },
{"add16",     "P",   "d,s,t",     MATCH_ADD16, MASK_ADD16, match_opcode, 0 },
{"add64",     "P",   "d,s,t",     MATCH_ADD64, MASK_ADD64, match_opcode, 0 },
{"ave",       "P",   "d,s,t",     MATCH_AVE, MASK_AVE, match_opcode, 0 },
{"bitrev",    "P",   "d,s,t",     MATCH_BITREV, MASK_BITREV, match_opcode, 0 },
{"bitrevi",   "P",   "d,s,l",     MATCH_BITREVI, MASK_BITREVI, match_opcode, 0 },
{"bpick",     "P",   "d,s,t,nds_rc", MATCH_BPICK, MASK_BPICK, match_opcode, 0 },
{"col",       "P",   "d,s",       MATCH_CLO, MASK_CLO, match_opcode, 0 },
{"clz",       "P",   "d,s",       MATCH_CLZ, MASK_CLZ, match_opcode, 0 },
{"cmpeq8",    "P",   "d,s,t",     MATCH_CMPEQ8, MASK_CMPEQ8, match_opcode, 0 },
{"cmpeq16",   "P",   "d,s,t",     MATCH_CMPEQ16, MASK_CMPEQ16, match_opcode, 0 },
{"cras16",    "P",   "d,s,t",     MATCH_CRAS16, MASK_CRAS16, match_opcode, 0 },
{"crsa16",    "P",   "d,s,t",     MATCH_CRSA16, MASK_CRSA16, match_opcode, 0 },
{"insb",      "P",   "d,s,nds_i3u", MATCH_INSB, MASK_INSB, match_opcode, 0 },
{"kabs8",     "P",   "d,s",       MATCH_KABS8, MASK_KABS8, match_opcode, 0 },
{"kabs16",    "P",   "d,s",       MATCH_KABS16, MASK_KABS16, match_opcode, 0 },
{"kadd8",     "P",   "d,s,t",     MATCH_KADD8, MASK_KADD8, match_opcode, 0 },
{"kadd16",    "P",   "d,s,t",     MATCH_KADD16, MASK_KADD16, match_opcode, 0 },
{"kadd64",    "P",   "d,s,t",     MATCH_KADD64, MASK_KADD64, match_opcode, 0 },
{"kaddh",     "P",   "d,s,t",     MATCH_KADDH, MASK_KADDH, match_opcode, 0 },
{"kaddw",     "P",   "d,s,t",     MATCH_KADDW, MASK_KADDW, match_opcode, 0 },
{"kcras16",   "P",   "d,s,t",     MATCH_KCRAS16, MASK_KCRAS16, match_opcode, 0 },
{"kcrsa16",   "P",   "d,s,t",     MATCH_KCRSA16, MASK_KCRSA16, match_opcode, 0 },
{"kdmbb",     "P",   "d,s,t",     MATCH_KDMBB, MASK_KDMBB, match_opcode, 0 },
{"kdmbt",     "P",   "d,s,t",     MATCH_KDMBT, MASK_KDMBT, match_opcode, 0 },
{"kdmtt",     "P",   "d,s,t",     MATCH_KDMTT, MASK_KDMTT, match_opcode, 0 },
{"khm16",     "P",   "d,s,t",     MATCH_KHM16, MASK_KHM16, match_opcode, 0 },
{"khmx16",    "P",   "d,s,t",     MATCH_KHMX16, MASK_KHMX16, match_opcode, 0 },
{"khmbb",     "P",   "d,s,t",     MATCH_KHMBB, MASK_KHMBB, match_opcode, 0 },
{"khmbt",     "P",   "d,s,t",     MATCH_KHMBT, MASK_KHMBT, match_opcode, 0 },
{"khmtt",     "P",   "d,s,t",     MATCH_KHMTT, MASK_KHMTT, match_opcode, 0 },
{"kmabb",     "P",   "d,s,t",     MATCH_KMABB, MASK_KMABB, match_opcode, 0 },
{"kmabt",     "P",   "d,s,t",     MATCH_KMABT, MASK_KMABT, match_opcode, 0 },
{"kmatt",     "P",   "d,s,t",     MATCH_KMATT, MASK_KMATT, match_opcode, 0 },
{"kmada",     "P",   "d,s,t",     MATCH_KMADA, MASK_KMADA, match_opcode, 0 },
{"kmaxda",    "P",   "d,s,t",     MATCH_KMAXDA, MASK_KMAXDA, match_opcode, 0 },
{"kmads",     "P",   "d,s,t",     MATCH_KMADS, MASK_KMADS, match_opcode, 0 },
{"kmadrs",    "P",   "d,s,t",     MATCH_KMADRS, MASK_KMADRS, match_opcode, 0 },
{"kmaxds",    "P",   "d,s,t",     MATCH_KMAXDS, MASK_KMAXDS, match_opcode, 0 },
{"kmar64",    "P",   "d,s,t",     MATCH_KMAR64, MASK_KMAR64, match_opcode, 0 },
{"kmda",      "P",   "d,s,t",     MATCH_KMDA, MASK_KMDA, match_opcode, 0 },
{"kmxda",     "P",   "d,s,t",     MATCH_KMXDA, MASK_KMXDA, match_opcode, 0 },
{"kmmac",     "P",   "d,s,t",     MATCH_KMMAC, MASK_KMMAC, match_opcode, 0 },
{"kmmac.u",   "P",   "d,s,t",     MATCH_KMMAC_U, MASK_KMMAC_U, match_opcode, 0 },
{"kmmawb",    "P",   "d,s,t",     MATCH_KMMAWB, MASK_KMMAWB, match_opcode, 0 },
{"kmmawb.u",  "P",   "d,s,t",     MATCH_KMMAWB_U, MASK_KMMAWB_U, match_opcode, 0 },
{"kmmawt",    "P",   "d,s,t",     MATCH_KMMAWT, MASK_KMMAWT, match_opcode, 0 },
{"kmmawt.u",  "P",   "d,s,t",     MATCH_KMMAWT_U, MASK_KMMAWT_U, match_opcode, 0 },
{"kmmsb",     "P",   "d,s,t",     MATCH_KMMSB, MASK_KMMSB, match_opcode, 0 },
{"kmmsb.u",   "P",   "d,s,t",     MATCH_KMMSB_U, MASK_KMMSB_U, match_opcode, 0 },
{"kmsda",     "P",   "d,s,t",     MATCH_KMSDA, MASK_KMSDA, match_opcode, 0 },
{"kmsxda",    "P",   "d,s,t",     MATCH_KMSXDA, MASK_KMSXDA, match_opcode, 0 },
{"kmsr64",    "P",   "d,s,t",     MATCH_KMSR64, MASK_KMSR64, match_opcode, 0 },
{"ksll",      "P",   "d,s,t",     MATCH_KSLL, MASK_KSLL, match_opcode, 0 },
{"kslli",     "P",   "d,s,nds_i5u", MATCH_KSLLI, MASK_KSLLI, match_opcode, 0 },
{"ksll8",     "P",   "d,s,t",     MATCH_KSLL8, MASK_KSLL8, match_opcode, 0 },
{"kslli8",    "P",   "d,s,nds_i3u", MATCH_KSLLI8, MASK_KSLLI8, match_opcode, 0 },
{"ksll16",    "P",   "d,s,t",     MATCH_KSLL16, MASK_KSLL16, match_opcode, 0 },
{"kslli16",   "P",   "d,s,nds_i4u", MATCH_KSLLI16, MASK_KSLLI16, match_opcode, 0 },
{"kslra8",    "P",   "d,s,t",     MATCH_KSLRA8, MASK_KSLRA8, match_opcode, 0 },
{"kslra8.u",  "P",   "d,s,t",     MATCH_KSLRA8_U, MASK_KSLRA8_U, match_opcode, 0 },
{"kslra16",   "P",   "d,s,t",     MATCH_KSLRA16, MASK_KSLRA16, match_opcode, 0 },
{"kslra16.u", "P",   "d,s,t",     MATCH_KSLRA16_U, MASK_KSLRA16_U, match_opcode, 0 },
{"kslraw",    "P",   "d,s,t",     MATCH_KSLRAW, MASK_KSLRAW, match_opcode, 0 },
{"kslraw.u",  "P",   "d,s,t",     MATCH_KSLRAW_U, MASK_KSLRAW_U, match_opcode, 0 },
{"ksub8",     "P",   "d,s,t",     MATCH_KSUB8, MASK_KSUB8, match_opcode, 0 },
{"ksub16",    "P",   "d,s,t",     MATCH_KSUB16, MASK_KSUB16, match_opcode, 0 },
{"ksub64",    "P",   "d,s,t",     MATCH_KSUB64, MASK_KSUB64, match_opcode, 0 },
{"ksubh",     "P",   "d,s,t",     MATCH_KSUBH, MASK_KSUBH, match_opcode, 0 },
{"ksubw",     "P",   "d,s,t",     MATCH_KSUBW, MASK_KSUBW, match_opcode, 0 },
{"kwmmul",    "P",   "d,s,t",     MATCH_KWMMUL, MASK_KWMMUL, match_opcode, 0 },
{"kwmmul.u",  "P",   "d,s,t",     MATCH_KWMMUL_U, MASK_KWMMUL_U, match_opcode, 0 },
{"mtlbi",     "P",   "nds_i15s",    MATCH_MTLBI, MASK_MTLBI, match_opcode, 0 },
{"mtlei",     "P",   "nds_i15s",    MATCH_MTLEI, MASK_MTLEI, match_opcode, 0 },
{"maddr32",   "P",   "d,s,t",     MATCH_MADDR32, MASK_MADDR32, match_opcode, 0 },
{"max",       "P",   "d,s,t",     MATCH_MAX, MASK_MAX, match_opcode, 0 },
{"min",       "P",   "d,s,t",     MATCH_MIN, MASK_MIN, match_opcode, 0 },
{"msubr32",   "P",   "d,s,t",     MATCH_MSUBR32, MASK_MSUBR32, match_opcode, 0 },
{"mulr64",    "P",   "d,s,t",     MATCH_MULR64, MASK_MULR64, match_opcode, 0 },
{"mulsr64",   "P",   "d,s,t",     MATCH_MULSR64, MASK_MULSR64, match_opcode, 0 },
{"pbsad",     "P",   "d,s,t",     MATCH_PBSAD, MASK_PBSAD, match_opcode, 0 },
{"pbsada",    "P",   "d,s,t",     MATCH_PBSADA, MASK_PBSADA, match_opcode, 0 },
{"pkbb16",    "P",   "d,s,t",     MATCH_PKBB16, MASK_PKBB16, match_opcode, 0 },
{"pkbt16",    "P",   "d,s,t",     MATCH_PKBT16, MASK_PKBT16, match_opcode, 0 },
{"pktt16",    "P",   "d,s,t",     MATCH_PKTT16, MASK_PKTT16, match_opcode, 0 },
{"pktb16",    "P",   "d,s,t",     MATCH_PKTB16, MASK_PKTB16, match_opcode, 0 },
{"radd8",     "P",   "d,s,t",     MATCH_RADD8, MASK_RADD8, match_opcode, 0 },
{"radd16",    "P",   "d,s,t",     MATCH_RADD16, MASK_RADD16, match_opcode, 0 },
{"radd64",    "P",   "d,s,t",     MATCH_RADD64, MASK_RADD64, match_opcode, 0 },
{"raddw",     "P",   "d,s,t",     MATCH_RADDW, MASK_RADDW, match_opcode, 0 },
{"rcras16",   "P",   "d,s,t",     MATCH_RCRAS16, MASK_RCRAS16, match_opcode, 0 },
{"rcrsa16",   "P",   "d,s,t",     MATCH_RCRSA16, MASK_RCRSA16, match_opcode, 0 },
{"rsub8",     "P",   "d,s,t",     MATCH_RSUB8, MASK_RSUB8, match_opcode, 0 },
{"rsub16",    "P",   "d,s,t",     MATCH_RSUB16, MASK_RSUB16, match_opcode, 0 },
{"rsub64",    "P",   "d,s,t",     MATCH_RSUB64, MASK_RSUB64, match_opcode, 0 },
{"rsubw",     "P",   "d,s,t",     MATCH_RSUBW, MASK_RSUBW, match_opcode, 0 },
{"sclip8",    "P",   "d,s,nds_i3u", MATCH_SCLIP8, MASK_SCLIP8, match_opcode, 0 },
{"sclip16",   "P",   "d,s,nds_i4u", MATCH_SCLIP16, MASK_SCLIP16, match_opcode, 0 },
{"sclip32",   "P",   "d,s,nds_i5u", MATCH_SCLIP32, MASK_SCLIP32, match_opcode, 0 },
{"scmple8",   "P",   "d,s,t",     MATCH_SCMPLE8, MASK_SCMPLE8, match_opcode, 0 },
{"scmple16",  "P",   "d,s,t",     MATCH_SCMPLE16, MASK_SCMPLE16, match_opcode, 0 },
{"scmplt8",   "P",   "d,s,t",     MATCH_SCMPLT8, MASK_SCMPLT8, match_opcode, 0 },
{"scmplt16",  "P",   "d,s,t",     MATCH_SCMPLT16, MASK_SCMPLT16, match_opcode, 0 },
{"sll8",      "P",   "d,s,t",     MATCH_SLL8, MASK_SLL8, match_opcode, 0 },
{"slli8",     "P",   "d,s,nds_i3u", MATCH_SLLI8, MASK_SLLI8, match_opcode, 0 },
{"sll16",     "P",   "d,s,t",     MATCH_SLL16, MASK_SLL16, match_opcode, 0 },
{"slli16",    "P",   "d,s,nds_i4u", MATCH_SLLI16, MASK_SLLI16, match_opcode, 0 },
{"smal",      "P",   "d,s,t",     MATCH_SMAL, MASK_SMAL, match_opcode, 0 },
{"smalbb",    "P",   "d,s,t",     MATCH_SMALBB, MASK_SMALBB, match_opcode, 0 },
{"smalbt",    "P",   "d,s,t",     MATCH_SMALBT, MASK_SMALBT, match_opcode, 0 },
{"smaltt",    "P",   "d,s,t",     MATCH_SMALTT, MASK_SMALTT, match_opcode, 0 },
{"smalda",    "P",   "d,s,t",     MATCH_SMALDA, MASK_SMALDA, match_opcode, 0 },
{"smalxda",   "P",   "d,s,t",     MATCH_SMALXDA, MASK_SMALXDA, match_opcode, 0 },
{"smalds",    "P",   "d,s,t",     MATCH_SMALDS, MASK_SMALDS, match_opcode, 0 },
{"smaldrs",   "P",   "d,s,t",     MATCH_SMALDRS, MASK_SMALDRS, match_opcode, 0 },
{"smalxds",   "P",   "d,s,t",     MATCH_SMALXDS, MASK_SMALXDS, match_opcode, 0 },
{"smar64",    "P",   "d,s,t",     MATCH_SMAR64, MASK_SMAR64, match_opcode, 0 },
{"smax8",     "P",   "d,s,t",     MATCH_SMAX8, MASK_SMAX8, match_opcode, 0 },
{"smax16",    "P",   "d,s,t",     MATCH_SMAX16, MASK_SMAX16, match_opcode, 0 },
{"smbb",      "P",   "d,s,t",     MATCH_SMBB, MASK_SMBB, match_opcode, 0 },
{"smbt",      "P",   "d,s,t",     MATCH_SMBT, MASK_SMBT, match_opcode, 0 },
{"smtt",      "P",   "d,s,t",     MATCH_SMTT, MASK_SMTT, match_opcode, 0 },
{"smds",      "P",   "d,s,t",     MATCH_SMDS, MASK_SMDS, match_opcode, 0 },
{"smdrs",     "P",   "d,s,t",     MATCH_SMDRS, MASK_SMDRS, match_opcode, 0 },
{"smxds",     "P",   "d,s,t",     MATCH_SMXDS, MASK_SMXDS, match_opcode, 0 },
{"smin8",     "P",   "d,s,t",     MATCH_SMIN8, MASK_SMIN8, match_opcode, 0 },
{"smin16",    "P",   "d,s,t",     MATCH_SMIN16, MASK_SMIN16, match_opcode, 0 },
{"smmul",     "P",   "d,s,t",     MATCH_SMMUL, MASK_SMMUL, match_opcode, 0 },
{"smmul.u",   "P",   "d,s,t",     MATCH_SMMUL_U, MASK_SMMUL_U, match_opcode, 0 },
{"smmwb",     "P",   "d,s,t",     MATCH_SMMWB, MASK_SMMWB, match_opcode, 0 },
{"smmwb.u",   "P",   "d,s,t",     MATCH_SMMWB_U, MASK_SMMWB_U, match_opcode, 0 },
{"smmwt",     "P",   "d,s,t",     MATCH_SMMWT, MASK_SMMWT, match_opcode, 0 },
{"smmwt.u",   "P",   "d,s,t",     MATCH_SMMWT_U, MASK_SMMWT_U, match_opcode, 0 },
{"smslda",    "P",   "d,s,t",     MATCH_SMSLDA, MASK_SMSLDA, match_opcode, 0 },
{"smslxda",   "P",   "d,s,t",     MATCH_SMSLXDA, MASK_SMSLXDA, match_opcode, 0 },
{"smsr64",    "P",   "d,s,t",     MATCH_SMSR64, MASK_SMSR64, match_opcode, 0 },
{"smul16",    "P",   "d,s,t",     MATCH_SMUL16, MASK_SMUL16, match_opcode, 0 },
{"smulx16",   "P",   "d,s,t",     MATCH_SMULX16, MASK_SMULX16, match_opcode, 0 },
{"sra.u",     "P",   "d,s,t",     MATCH_SRA_U, MASK_SRA_U, match_opcode, 0 },
{"srai.u",    "P",   "d,s,nds_i5u", MATCH_SRAI_U, MASK_SRAI_U, match_opcode, 0 },
{"sra8",      "P",   "d,s,t",     MATCH_SRA8, MASK_SRA8, match_opcode, 0 },
{"sra8.u",    "P",   "d,s,t",     MATCH_SRA8_U, MASK_SRA8_U, match_opcode, 0 },
{"srai8",     "P",   "d,s,nds_i3u", MATCH_SRAI8, MASK_SRAI8, match_opcode, 0 },
{"srai8.u",   "P",   "d,s,nds_i3u", MATCH_SRAI8_U, MASK_SRAI8_U, match_opcode, 0 },
{"sra16",     "P",   "d,s,t",     MATCH_SRA16, MASK_SRA16, match_opcode, 0 },
{"sra16.u",   "P",   "d,s,t",     MATCH_SRA16_U, MASK_SRA16_U, match_opcode, 0 },
{"srai16",    "P",   "d,s,nds_i4u", MATCH_SRAI16, MASK_SRAI16, match_opcode, 0 },
{"srai16.u",  "P",   "d,s,nds_i4u", MATCH_SRAI16_U, MASK_SRAI16_U, match_opcode, 0 },
{"srl8",      "P",   "d,s,t",     MATCH_SRL8, MASK_SRL8, match_opcode, 0 },
{"srl8.u",    "P",   "d,s,t",     MATCH_SRL8_U, MASK_SRL8_U, match_opcode, 0 },
{"srli8",     "P",   "d,s,nds_i3u", MATCH_SRLI8, MASK_SRLI8, match_opcode, 0 },
{"srli8.u",   "P",   "d,s,nds_i3u", MATCH_SRLI8_U, MASK_SRLI8_U, match_opcode, 0 },
{"srl16",     "P",   "d,s,t",     MATCH_SRL16, MASK_SRL16, match_opcode, 0 },
{"srl16.u",   "P",   "d,s,t",     MATCH_SRL16_U, MASK_SRL16_U, match_opcode, 0 },
{"srli16",    "P",   "d,s,nds_i4u", MATCH_SRLI16, MASK_SRLI16, match_opcode, 0 },
{"srli16.u",  "P",   "d,s,nds_i4u", MATCH_SRLI16_U, MASK_SRLI16_U, match_opcode, 0 },
{"sub8",      "P",   "d,s,t",     MATCH_SUB8, MASK_SUB8, match_opcode, 0 },
{"sub16",     "P",   "d,s,t",     MATCH_SUB16, MASK_SUB16, match_opcode, 0 },
{"sub64",     "P",   "d,s,t",     MATCH_SUB64, MASK_SUB64, match_opcode, 0 },
{"sunpkd810", "P",   "d,s",       MATCH_SUNPKD810, MASK_SUNPKD810, match_opcode, 0 },
{"sunpkd820", "P",   "d,s",       MATCH_SUNPKD820, MASK_SUNPKD820, match_opcode, 0 },
{"sunpkd830", "P",   "d,s",       MATCH_SUNPKD830, MASK_SUNPKD830, match_opcode, 0 },
{"sunpkd831", "P",   "d,s",       MATCH_SUNPKD831, MASK_SUNPKD831, match_opcode, 0 },
{"sunpkd832", "P",   "d,s",       MATCH_SUNPKD832, MASK_SUNPKD832, match_opcode, 0 },
{"swap8",     "P",   "d,s",       MATCH_SWAP8, MASK_SWAP8, match_opcode, 0 },
{"swap16",    "P",   "d,s",       MATCH_SWAP16, MASK_SWAP16, match_opcode, 0 },
{"uclip8",    "P",   "d,s,nds_i3u", MATCH_UCLIP8, MASK_UCLIP8, match_opcode, 0 },
{"uclip16",   "P",   "d,s,nds_i4u", MATCH_UCLIP16, MASK_UCLIP16, match_opcode, 0 },
{"uclip32",   "P",   "d,s,nds_i5u", MATCH_UCLIP32, MASK_UCLIP32, match_opcode, 0 },
{"ucmple8",   "P",   "d,s,t",     MATCH_UCMPLE8, MASK_UCMPLE8, match_opcode, 0 },
{"ucmple16",  "P",   "d,s,t",     MATCH_UCMPLE16, MASK_UCMPLE16, match_opcode, 0 },
{"ucmplt8",   "P",   "d,s,t",     MATCH_UCMPLT8, MASK_UCMPLT8, match_opcode, 0 },
{"ucmplt16",  "P",   "d,s,t",     MATCH_UCMPLT16, MASK_UCMPLT16, match_opcode, 0 },
{"ukadd8",    "P",   "d,s,t",     MATCH_UKADD8, MASK_UKADD8, match_opcode, 0 },
{"ukadd16",   "P",   "d,s,t",     MATCH_UKADD16, MASK_UKADD16, match_opcode, 0 },
{"ukadd64",   "P",   "d,s,t",     MATCH_UKADD64, MASK_UKADD64, match_opcode, 0 },
{"ukcras16",  "P",   "d,s,t",     MATCH_UKCRAS16, MASK_UKCRAS16, match_opcode, 0 },
{"ukcrsa16",  "P",   "d,s,t",     MATCH_UKCRSA16, MASK_UKCRSA16, match_opcode, 0 },
{"ukmar64",   "P",   "d,s,t",     MATCH_UKMAR64, MASK_UKMAR64, match_opcode, 0 },
{"ukmsr64",   "P",   "d,s,t",     MATCH_UKMSR64, MASK_UKMSR64, match_opcode, 0 },
{"uksub8",    "P",   "d,s,t",     MATCH_UKSUB8, MASK_UKSUB8, match_opcode, 0 },
{"uksub16",   "P",   "d,s,t",     MATCH_UKSUB16, MASK_UKSUB16, match_opcode, 0 },
{"uksub64",   "P",   "d,s,t",     MATCH_UKSUB64, MASK_UKSUB64, match_opcode, 0 },
{"umar64",    "P",   "d,s,t",     MATCH_UMAR64, MASK_UMAR64, match_opcode, 0 },
{"umax8",     "P",   "d,s,t",     MATCH_UMAX8, MASK_UMAX8, match_opcode, 0 },
{"umax16",    "P",   "d,s,t",     MATCH_UMAX16, MASK_UMAX16, match_opcode, 0 },
{"umin8",     "P",   "d,s,t",     MATCH_UMIN8, MASK_UMIN8, match_opcode, 0 },
{"umin16",    "P",   "d,s,t",     MATCH_UMIN16, MASK_UMIN16, match_opcode, 0 },
{"umsr64",    "P",   "d,s,t",     MATCH_UMSR64, MASK_UMSR64, match_opcode, 0 },
{"umul16",    "P",   "d,s,t",     MATCH_UMUL16, MASK_UMUL16, match_opcode, 0 },
{"umulx16",   "P",   "d,s,t",     MATCH_UMULX16, MASK_UMULX16, match_opcode, 0 },
{"uradd8",    "P",   "d,s,t",     MATCH_URADD8, MASK_URADD8, match_opcode, 0 },
{"uradd16",   "P",   "d,s,t",     MATCH_URADD16, MASK_URADD16, match_opcode, 0 },
{"uradd64",   "P",   "d,s,t",     MATCH_URADD64, MASK_URADD64, match_opcode, 0 },
{"uraddw",    "P",   "d,s,t",     MATCH_URADDW, MASK_URADDW, match_opcode, 0 },
{"urcras16",  "P",   "d,s,t",     MATCH_URCRAS16, MASK_URCRAS16, match_opcode, 0 },
{"urcrsa16",  "P",   "d,s,t",     MATCH_URCRSA16, MASK_URCRSA16, match_opcode, 0 },
{"ursub8",    "P",   "d,s,t",     MATCH_URSUB8, MASK_URSUB8, match_opcode, 0 },
{"ursub16",   "P",   "d,s,t",     MATCH_URSUB16, MASK_URSUB16, match_opcode, 0 },
{"ursub64",   "P",   "d,s,t",     MATCH_URSUB64, MASK_URSUB64, match_opcode, 0 },
{"ursubw",    "P",   "d,s,t",     MATCH_URSUBW, MASK_URSUBW, match_opcode, 0 },
{"wexti",     "P",   "d,s,nds_i5u", MATCH_WEXTI, MASK_WEXTI, match_opcode, 0 },
{"wext",      "P",   "d,s,t",     MATCH_WEXT, MASK_WEXT, match_opcode, 0 },
{"zunpkd810", "P",   "d,s",       MATCH_ZUNPKD810, MASK_ZUNPKD810, match_opcode, 0 },
{"zunpkd820", "P",   "d,s",       MATCH_ZUNPKD820, MASK_ZUNPKD820, match_opcode, 0 },
{"zunpkd830", "P",   "d,s",       MATCH_ZUNPKD830, MASK_ZUNPKD830, match_opcode, 0 },
{"zunpkd831", "P",   "d,s",       MATCH_ZUNPKD831, MASK_ZUNPKD831, match_opcode, 0 },
{"zunpkd832", "P",   "d,s",       MATCH_ZUNPKD832, MASK_ZUNPKD832, match_opcode, 0 },
